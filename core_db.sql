...
(000001, 'Bananas', 'Six bananas from Brazil', '500g', 20, 1, 1, 1, 1.5, 'carol25kle@gmail.com'),
(000002, 'Papaya', 'one papaya from Brazil', '150g', 20, 1, 1, 1, 0.85, 'carol25kle@gmail.com'),
(000003, 'Acai cream', 'Delicious healthy ice cream made of acai, a fruit only cultivated in amazonia forest.', '1L', 20, 2, 1, 1, 3.25, 'carol25kle@gmail.com'),
(000004, 'Cachaca', 'strong alcooholic drink made with sugarcane', '1L', 20, 4, 1, 2, 20, 'carol25kle@gmail.com');
...
CREATE TABLE IF NOT EXISTS `supplier` (
  `ID` int(6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
  `IDProduct` int(6) UNSIGNED ZEROFILL NOT NULL,
  `name` varchar(20) NOT NULL,
  `description` varchar(100) NOT NULL,
  `weight` varchar(20) NOT NULL,
  `quantity` int(5) NOT NULL,
