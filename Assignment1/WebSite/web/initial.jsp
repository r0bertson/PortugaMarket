                            ...
                            <td width="800px">
                               <form name="login" action="login.jsp">
                                    <table border="0" width="30%">    
                                        <tr>
                                            <td><font size="6" face="Monotype Corsiva" color="#FFFFFF"> Login: </font></td>
                                            <td><input type="text" size="20" value ="" name="usuario"/></td>
                                        </tr>
                                        <tr>
                                            <td><font size="6" face="Monotype Corsiva" color="#FFFFFF"> Password: </font></td>
                                            <td><input type="password" value ="" name ="senha" size="20"/></td>                                                    
                                        </tr>
                                        <tr> 
                                            <td colspan="2"><font size="6" face="Monotype Corsiva" color="#FFFFFF" onclick="javascript:verificaCampos()"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Enter</font>
                                            </td>
                                        </tr>
                                        <tr>
