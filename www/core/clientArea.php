...
<div id="wrapper">
   ...
   <div id="main">
    <div id="left">
      ...
      <p>Hello, <?php echo $name; ?>. You can update your loyalty number in the following box.</p>
	 ...
	 <?php echo $information; ?>
      <form id="form1" name="form1" method="post" action="">
        ...
        <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span><span class="textfieldMinCharsMsg">Minimum number of digits not met.</span><span class="textfieldMaxCharsMsg">Exceeded maximum number of digits.</span></span></p>
        <p>
