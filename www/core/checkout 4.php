...
<!-- 
16/04 - the following code will udpate the stock
...
<?php 
	...
	foreach ($_SESSION["cart_storage"] as $each_item) { 
		...
		if( $quantity < 5){
			...
			$query = "INSERT INTO core_db.supplier (`IDProduct`, `name`, `description`, `weight`, `quantity`, `specialoffer`, `nationality`, `category`, `price`, `emailSupplier`) VALUES('$id', '$name',  '$description', '$weight', '$quantity', '$specialoffer', '$nationality', '$category', '$price', '$emailSupplier')";
