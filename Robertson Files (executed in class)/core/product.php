...
<table width="100%" border="0" cellspacing="0" cellpadding="15">
  <tr>
    <td width="19%" valign="top"> <a href="product_images/<?php echo $id; ?>.jpg"><img src="product_images/<?php echo $id; ?>.jpg" width="200" border="0" height="300" alt="<?php echo $name; ?>" /><br />
     </a></td>
